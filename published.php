<?php
    ...
    if (isset($_POST['submit'])) {
		...
		$stmt = $conn->prepare("SELECT Books.book_title, Publisher.publisher_name 
                                FROM Books 
                                INNER JOIN Publisher ON Books.publisher_id = Publisher.publisher_id 
                                WHERE Books.book_name = ?");
		$stmt->bind_param("i", $book_name);
		$stmt->execute();

		$stmt->bind_result($book_title, $publisher_name);
	}
	?>
...
<div class="wrapper">
    ...
    <div class="main_content">
        ...
        <img src="images/icon/monitoring.png" alt="" height="300px" width="300px" style="margin-top: 30px;">
    </div>
    <section class="container my-2 bg-dark w-50 text-light p-2">
    <form class="row g-3 p-3" method="post" action="published.php">
      ...
      <?php
			...
			echo "<p>PUBLISHER NAME: $publisher_name</p>";
		} else {
